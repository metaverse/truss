...
// Changing the contents of these strings, even a little bit, will cause tests
...
var HTTPAssistFuncs string = PathParamsTemplate + BuildParamMapTemplate + RemoveBracesTemplate + QueryParamsTemplate
