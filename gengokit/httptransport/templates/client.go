...
const bbb2306ClientEncodeTemplate = `
{{- with $binding := . -}}
...
// instance. We expect instance to come from a service discovery system, so
// likely of the form "host:port".
func New(instance string, options ...ClientOption) (handlers.{{GoName .Service.Name}}Servicer, error) {
	var cc clientConfig
...
var Client = map[string]map[string]string{
	"bbb2306": {
		"ClientEncodeTemplate": bbb2306ClientEncodeTemplate,
		"ClientTemplate":       bbb2306ClientTemplate,
	},
	"v0.5.0": {
		"ClientEncodeTemplate": bbb2306ClientEncodeTemplate,
		"ClientTemplate":       v050ClientTemplate,
	},
}
