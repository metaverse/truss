...
func nameServiceNameServerServer_mainGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "NAME-service/NAME-server/server_main.gotemplate", size: 3464, mode: os.FileMode(436), modTime: time.Unix(1480970892, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func nameServiceMiddlewaresEndpointsGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "NAME-service/middlewares/endpoints.gotemplate", size: 76, mode: os.FileMode(436), modTime: time.Unix(1480970892, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func nameServiceMiddlewaresServiceGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "NAME-service/middlewares/service.gotemplate", size: 76, mode: os.FileMode(436), modTime: time.Unix(1480970892, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
