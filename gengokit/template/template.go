...
func nameServiceNameCliClientClient_mainGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "NAME-service/NAME-cli-client/client_main.gotemplate", size: 2788, mode: os.FileMode(436), modTime: time.Unix(1478659948, 0)}
...
func nameServiceGeneratedCliHandlersClient_handlerGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "NAME-service/generated/cli/handlers/client_handler.gotemplate", size: 744, mode: os.FileMode(436), modTime: time.Unix(1478659028, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func nameServiceGeneratedTransport_httpGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "NAME-service/generated/transport_http.gotemplate", size: 105, mode: os.FileMode(436), modTime: time.Unix(1478654064, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func nameServiceHandlersServerServer_handlerGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "NAME-service/handlers/server/server_handler.gotemplate", size: 770, mode: os.FileMode(436), modTime: time.Unix(1478654064, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
