...
func svcServerRunGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "svc/server/run.gotemplate", size: 2783, mode: os.FileMode(420), modTime: time.Unix(1464111000, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
