...
// sources:
// NAME-service/cmd/NAME/main.gotemplate (4.178kB)
// NAME-service/cmd/NAME-server/main.gotemplate (383B)
...
// NAME-service/svc/client/cli/handlers/handlers.gotemplate (885B)
...
// NAME-service/svc/server/cli/cli.gotemplate (1.043kB)
// NAME-service/svc/server/run.gotemplate (2.466kB)
// NAME-service/svc/transport_grpc.gotemplate (2.873kB)
...
func cmdNameMainGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "cmd/NAME/main.gotemplate", size: 4178, mode: os.FileMode(0644), modTime: time.Unix(1464111000, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x59, 0x47, 0xe7, 0xfc, 0x78, 0x33, 0x9b, 0x69, 0xfc, 0x4, 0x48, 0x67, 0x49, 0xfc, 0x23, 0x69, 0x0, 0xb5, 0x2f, 0xc3, 0x7d, 0x48, 0x7, 0xd3, 0xa9, 0xef, 0x73, 0x85, 0xae, 0x28, 0xa0, 0x2e}}
	return a, nil
}
...
func cmdNameServerMainGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "cmd/NAME-server/main.gotemplate", size: 383, mode: os.FileMode(0644), modTime: time.Unix(1464111000, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x77, 0x27, 0xe6, 0xa6, 0x80, 0xe, 0x62, 0x69, 0xa8, 0x9, 0xd7, 0x82, 0x1d, 0x1e, 0xa5, 0xc8, 0x41, 0x66, 0x3e, 0xd0, 0x83, 0x84, 0x46, 0xce, 0x47, 0x64, 0x18, 0xde, 0xdd, 0xf1, 0xa8, 0x50}}
	return a, nil
}
...
func svcClientCliHandlersHandlersGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "svc/client/cli/handlers/handlers.gotemplate", size: 885, mode: os.FileMode(0644), modTime: time.Unix(1464111000, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xfd, 0x8f, 0xb6, 0x8d, 0x6, 0xe8, 0x3e, 0xcf, 0xa6, 0xdd, 0x18, 0xb3, 0x3a, 0x6e, 0xb7, 0x38, 0x6b, 0xfd, 0xa3, 0xee, 0x18, 0xcd, 0x3d, 0xc7, 0xe1, 0xcc, 0x41, 0xa6, 0x46, 0x8e, 0xa, 0x8e}}
	return a, nil
}
...
func svcServerCliCliGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "svc/server/cli/cli.gotemplate", size: 1043, mode: os.FileMode(0644), modTime: time.Unix(1464111000, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xa4, 0xb, 0xb2, 0xb1, 0x74, 0x99, 0x29, 0x6c, 0xff, 0x24, 0xc9, 0x79, 0x92, 0x36, 0x63, 0x55, 0x8, 0xa7, 0xc5, 0x3c, 0xd0, 0x22, 0x83, 0xa, 0x1e, 0xc5, 0x39, 0xf5, 0x1b, 0xab, 0x7c, 0x66}}
	return a, nil
}
...
func svcServerRunGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "svc/server/run.gotemplate", size: 2466, mode: os.FileMode(0644), modTime: time.Unix(1464111000, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x10, 0x17, 0x6f, 0xc8, 0xf4, 0x3a, 0xd6, 0x0, 0x9e, 0xd4, 0xdd, 0x2a, 0xa4, 0xa, 0xa5, 0xa8, 0xc1, 0x32, 0x7d, 0xf6, 0x79, 0xe4, 0x31, 0xda, 0xa0, 0xd5, 0x1, 0xcd, 0x44, 0xa, 0x20, 0x72}}
	return a, nil
}
...
func svcTransport_grpcGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "svc/transport_grpc.gotemplate", size: 2873, mode: os.FileMode(0644), modTime: time.Unix(1464111000, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x57, 0x7e, 0xa6, 0x5c, 0x23, 0xb, 0xca, 0x93, 0x28, 0x2e, 0xf2, 0xcf, 0xce, 0xcd, 0x61, 0x6b, 0x2f, 0xd3, 0x90, 0x56, 0xf7, 0xf0, 0x86, 0x19, 0x39, 0xf8, 0x86, 0xc3, 0x9, 0xde, 0x8, 0x99}}
	return a, nil
}
