...
func nameServiceNameServerServer_mainGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "NAME-service/NAME-server/server_main.gotemplate", size: 3235, mode: os.FileMode(436), modTime: time.Unix(1479942637, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
