...
func nameServiceNameServerServer_mainGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "NAME-service/NAME-server/server_main.gotemplate", size: 3463, mode: os.FileMode(436), modTime: time.Unix(1481054532, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func nameServiceGeneratedClientGrpcClientGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "NAME-service/generated/client/grpc/client.gotemplate", size: 2200, mode: os.FileMode(436), modTime: time.Unix(1481505627, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
