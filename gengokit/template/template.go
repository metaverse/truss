...
func nameServiceNameServerServer_mainGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "NAME-service/NAME-server/server_main.gotemplate", size: 3215, mode: os.FileMode(436), modTime: time.Unix(1479871113, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
