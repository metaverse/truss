...
func nameServiceGeneratedEndpointsGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "NAME-service/generated/endpoints.gotemplate", size: 3010, mode: os.FileMode(420), modTime: time.Unix(1464111000, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
