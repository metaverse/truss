...
import (
	...
	helper "github.com/Unity-Technologies/truss/gengokit/gentesthelper"
...
func TestApplyServerTempl(t *testing.T) {
	...
	conf := gengokit.Config{
		GoPackage: "github.com/Unity-Technologies/truss/gengokit/general-service",
	...
	expected := `
		...
		import (
			...
			pb "github.com/Unity-Technologies/truss/gengokit/general-service"
		)
