...
type Service interface {
	...
	Concat(ctx context.Context, in pb.ConcatRequest) (pb.ConcatReply, error)
}
...
func (s basicService) Sum(ctx context.Context, in pb.SumRequest) (pb.SumReply, error) {
	_ = ctx
	_ = in
	return pb.SumReply{}, nil
}

func (s basicService) Concat(ctx context.Context, in pb.ConcatRequest) (pb.ConcatReply, error) {
	_ = ctx
	_ = in
